...
Y.namespace('M.atto_orderedlist').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    initializer: function() {
        this.addButton({
            callback: this._insertOrderedList,
     ...
     * InsertOrderedList
     *
     * @method _insertOrderedList
     * @private
     */
    _insertOrderedList: function() {
        // Set direction according to current page language.
        var html = '<ol dir="' + this.buttons.orderedlist.coreDirection + '" style="' +
            this.buttons.orderedlist.styleAlignment + '"><li></li></ol>';
