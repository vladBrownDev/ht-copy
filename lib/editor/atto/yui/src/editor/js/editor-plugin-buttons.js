...
EditorPluginButtons.prototype = {
    ...
    addButton: function(config) {
        ...
        button.coreDirection = Y.one('body').hasClass('dir-rtl') ? 'rtl' : 'ltr';
        if (button.coreDirection === 'rtl') {
            button.styleAlignment = 'text-align: right;';
        } else {
            button.styleAlignment = 'text-align: left;';
        }
        return button;
    },
