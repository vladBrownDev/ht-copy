...
EditorClean.prototype = {
    ...
    _cleanStyles: function(content) {
        ...
        var i = 0;
        // Add 'dir' & 'style' attributes according to the coreDirection.
        var alignment = '';
        if (this.coreDirection === 'rtl') {
        ...
        for (i = 0; i < elementsWithStyle.length; i++) {
            ...
            elementsWithStyle[i].setAttribute('dir', this.coreDirection);
            elementsWithStyle[i].setAttribute('style', alignment);
        }
